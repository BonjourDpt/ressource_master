 ...
 */
export type CheckGroupID = string & {
 ...
 * File type.
 */
export declare enum ExistsType {
    /**
 ...
 */
export type ModuleConfigClientID = string & {
...
export declare class CheckGroup extends BaseClient {
    private readonly _id?;
    /**
     * Constructor is used for internal usage only, do not create object from it.
     */
 ...
 */
export declare class Stat extends BaseClient {
    private readonly _id?;
